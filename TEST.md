...
- [gha-docker-build-push-dockerhub](https://github.com/kolosovpetro/CarsIslandProject/blob/master/.github/workflows/docker-build-push-webapi.yml)
- [azdo-push-nuget-artifacts](https://github.com/kolosovpetro/azdo-nuget-artifacts)
- [azdo-docker-build-push-acr](https://github.com/EventTriangle/EventTriangleAPI/blob/main/build/templates/docker-build-push-jobs.yml)
- [azdo-docker-build-push-dockerhub](https://github.com/EventTriangle/EventTriangleAPI/blob/main/build/templates/docker-build-push-jobs.yml)
...
- [sonarcloud-azure-devops-cicd](https://github.com/kolosovpetro/sonarcloud-azure-devops-cicd)
- [trivy-cve-scan-azure-devops-cicd](https://github.com/kolosovpetro/trivy-cve-scan-azure-devops-cicd)
- [snyk-security-scan-azure-devops-cicd](https://github.com/kolosovpetro/snyk-security-scan-azure-devops-cicd)

## Dynamic code analysis

- [owasp-zap-scan](https://github.com/kolosovpetro/movies-api-deployments-linux-iis-k8s-etc/blob/master/azure-pipelines/azdo-owasp-scan.yml)

## Automation

- [azdo-gha-ssh-cicd-playground](https://github.com/kolosovpetro/azdo-gha-ssh-cicd-playground)
- [azcopy-gha-yaml-pipelines](https://github.com/kolosovpetro/azcopy-azdo-gha-yaml-pipelines)
- [azcopy-azdo-yaml-pipelines](https://github.com/kolosovpetro/azcopy-azdo-gha-yaml-pipelines)
...
- [azure-windows-vm-terraform](https://github.com/kolosovpetro/azure-windows-vm-terraform)
- [azure-linux-vm-terraform](https://github.com/kolosovpetro/azure-linux-vm-terraform)

### Azure App Gateway

- [azure-app-gateway-paas-backend-terraform](https://github.com/kolosovpetro/azure-app-gateway-paas-backend-terraform)
- [azure-app-gateway-vm-backend-terraform](https://github.com/kolosovpetro/azure-app-gateway-vm-backend-terraform)

### VPN

- [azure-s2s-vpn-digital-ocean](https://github.com/kolosovpetro/azure-s2s-vpn-digital-ocean)
- [azure-p2s-vpn-terraform](https://github.com/kolosovpetro/azure-p2s-vpn-terraform)
...
- [azure-vm-start-stop-automation-terraform](https://github.com/kolosovpetro/azure-vm-start-stop-automation-terraform)
...
- [prometheus-win-linux-node-exporters-grafana-alertmanager-slack](https://github.com/kolosovpetro/prometheus-win-linux-node-exporters-grafana-alertmanager-slack)
...
- [azure-service-endpoint-between-blob-and-vm](https://github.com/kolosovpetro/azure-service-endpoint-between-blob-and-vm)
- [azure-private-endpoint-vm-sql-server](https://github.com/kolosovpetro/azure-private-endpoint-vm-sql-server)

### Networking

- [azure-nat-gateway-for-azdo-agent](https://github.com/kolosovpetro/azure-nat-gateway-for-azdo-agent)
- [azure-firewall-for-selfhosted-azdo-agent](https://github.com/kolosovpetro/azure-firewall-for-selfhosted-azdo-agent)
